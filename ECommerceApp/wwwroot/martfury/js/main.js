        ...
        if (target.length > 0) {
            target.each(function () {
                var el = $(this),
                    ...
                    dataHeight = el.data('owl-height') ? el.data('owl-height') : null,
                    datamouseDrag =
                        el.data('owl-mousedrag') == 'on' ? true : false;
                if (
                    el.children('div, span, a, img, h1, h2, h3, h4, h5, h5')
                        .length >= 1
                ) {
                    ...
                    // Áp dụng chiều cao tùy chỉnh nếu có
                    if (dataHeight) {
                        el.css({
                            'max-height': dataHeight + 'px',
                            'overflow': 'hidden'
                        });
                        el.find('.owl-stage-outer, .owl-stage, .owl-item').css({
                            'max-height': dataHeight + 'px'
                        });
                    }
                }
